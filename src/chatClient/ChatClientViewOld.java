 ...
 * @author rbary
 */
public class ChatClientViewOld extends JFrame {
    /**
     * Creates new form ChatClientGUI
     * @param chatClientController
     */
    public ChatClientViewOld(ChatClientController chatClientController) throws UnsupportedLookAndFeelException {
